...
export default function RestaurantReviewList() {
  ...
  const applyFilters = () => {
    setShowFilterModal(false);
    fetchReviews(1, searchTerm, statusFilter, minRating, maxRating, startDate, endDate);
  };
        ...
        <div className="flex flex-col gap-3 items-center m-3">
          <div className="flex flex-col sm:flex-row w-full gap-2">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-center gap-2">
              <button
                className={`flex items-center gap-2 px-4 py-2 rounded-lg shadow-md border text-gray-600 hover:shadow-lg relative whitespace-nowrap ${
