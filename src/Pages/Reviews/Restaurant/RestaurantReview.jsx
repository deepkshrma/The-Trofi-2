...
function RestaurantReview() {
  ...
  async function fetchHashtagsForRating(rating) {
    try {
      ...
      const type = review?.type || "Restaurant";
  ...
  // ====== UPDATE handleEnterEditMode FUNCTION (around line 180) ======
  function handleEnterEditMode() {
    ...
    setEditedImages(review.images); // Keep original images
    setNewImages([]); // Clear new images
    setRemovedImageIds([]); // Clear removed IDs
  ...
  // ====== UPDATE handleCancelEdit FUNCTION (around line 200) ======
  ...
  // ====== UPDATE handleSaveEdit FUNCTION (around line 210) ======
  ...
  return (
    <div className="main main_page w-full p-4 md:p-6 space-y-6 md:space-y-8 min-h-screen  duration-900">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <PageTitle title={`Review — ${review.restaurant.restro_name || review.restaurant.dish_name || "Review"}`} />
        ...
        <div className="flex flex-wrap items-center gap-4">
          ...
          <div>
            <h2 className="text-xl font-bold text-gray-800">
              {review.restaurant.restro_name || review.restaurant.dish_name || "Restaurant"}
            </h2>
