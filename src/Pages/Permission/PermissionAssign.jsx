...
//         ]}
//       />
//       <PageTitle title={`Assign Permissions for ${type === "admin" ? "Admin" : "Restaurant"}`} />
...
//           <p className="text-gray-500 text-sm">{email || "No email available"}</p>
//         </div>
...
//                         {["is_view", "is_create", "is_update", "is_delete"].map((key) => (
...
//               } text-white font-semibold px-8 py-2 cursor-pointer rounded-lg transition`}
//           >
