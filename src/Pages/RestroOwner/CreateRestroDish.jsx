...
function CreateRestroDish() {
    ...
    useEffect(() => {
        ...
        // ✅ First fetch the logged-in user's profile to get their restaurant
        axios
            .get(`${BASE_URL}/admin/admin-profile`, config)
            .then((profileRes) => {
                const loggedInRestaurantId = profileRes.data?.data?._id;

                // Now fetch restaurants dropdown
                return axios
                    ...
                    .then((res) => {
                        ...
                        // ✅ Use restaurantId from URL params, OR fallback to logged-in restaurant
                        const targetRestaurantId = restaurantId || loggedInRestaurantId;

                        if (targetRestaurantId) {
                            const selected = allRestaurants.find((r) => r._id === targetRestaurantId);
                            if (selected) {
...
export default CreateRestroDish;