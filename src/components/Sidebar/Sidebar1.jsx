...
const SidebarItem = ({
  ...
  return (
    <li className="text-sm ml-2 rounded-sm leading-[100%] tracking-[0.3px] transition-colors duration-200 group relative">
      {item.dropdown ? (
        <div
          onClick={handleClick}
          className={`flex w-full justify-between items-center pl-3 pr-3 py-4 rounded-tl-full rounded-bl-full cursor-pointer hover:bg-[#ffffff] text-white group hover:text-[#F9832B]  ${
            openDropdown === item.name
              ? "bg-[#ffffff] text-[#F9832B]"
              : "text-white"
          }`}
        >
...
function Sidebar1({ setIs_Toggle, isToggle }) {
      ...
      subItems: [
        {
          ...
          link: "#",
          dropdown: true, // nested dropdown
          subItems: [
            { name: "Add Amenity", link: "RestroAmenity" },
            { name: "Amenity List", link: "RestroAmenityList" },
          ],
        },
        {
          ...
          dropdown: true,
          subItems: [
            { name: "Add Type", link: "RestroType" },
            { name: "Type List", link: "RestroTypeList" },
          ],
        },
      ],
    },
  ...
  return (
    ...
    ${isToggle ? "translate-x-0 " : "-translate-x-full "} shadow-lg`}
        >
          ...
          {/* Logo */}
          <div className="flex items-center gap-2 logo-container top-0 left-0 text-white font-[900] text-3xl px-4 py-5 z-[99]">
            {/* <GiChefToque /> */}
